...
Configuration parameters:
  url = http://southpark.answers.wikia.com/wiki/South_Park_Answers
  name = South_Park_Answers
...
class Family(family.Family):
    def __init__(self):
        ...
        self.name = 'South_Park_Answers'
        self.langs = {
            'en': 'southpark.answers.wikia.com',
        }

        self.namespaces[4] = self.namespaces.get(4, {})
        self.namespaces[4][u'en'] = [u'South Park Answers']
        self.namespaces[5] = self.namespaces.get(5, {})
        self.namespaces[5][u'en'] = [u'South Park Answers talk']
