...
Configuration parameters:
  url = http://xbox.answers.wikia.com/wiki/Wikianswers_Xbox
  name = xbox
...
class Family(family.Family):
    def __init__(self):
        ...
        self.name = 'xbox'
        self.langs = {
            'en': 'xbox.answers.wikia.com',
        }

        self.namespaces[4] = self.namespaces.get(4, {})
        self.namespaces[4][u'en'] = [u'Wikianswers Xbox']
        self.namespaces[5] = self.namespaces.get(5, {})
        self.namespaces[5][u'en'] = [u'Wikianswers Xbox talk']
